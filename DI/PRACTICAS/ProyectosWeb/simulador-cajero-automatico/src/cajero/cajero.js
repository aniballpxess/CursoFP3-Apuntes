...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const STATE = Object.freeze({
        ...
        TAKING_OUT_MONEY_1: 'TAKING_OUT_MONEY_1',
        TAKING_OUT_MONEY_2: 'TAKING_OUT_MONEY_2',
    ...
    /** @type {HTMLButtonElement[]} */
    const BUTTONS = [];
    BUTTONS.push(act_btn_history);
    BUTTONS.push(act_btn_check);
    BUTTONS.push(act_btn_take);
    BUTTONS.push(act_btn_exit);
    BUTTONS.push(typing_btn_9);
    BUTTONS.push(typing_btn_8);
    BUTTONS.push(typing_btn_7);
    BUTTONS.push(typing_btn_6);
    BUTTONS.push(typing_btn_5);
    BUTTONS.push(typing_btn_4);
    BUTTONS.push(typing_btn_3);
    BUTTONS.push(typing_btn_2);
    BUTTONS.push(typing_btn_1);
    BUTTONS.push(typing_btn_0);
    BUTTONS.push(act_btn_next);
    BUTTONS.push(sim_btn_card);
    BUTTONS.push(sim_btn_money);
        ...
        switch (current_state) {
            ...
            case STATE.SELECTING_OPERATION:
                ...
                if (current_action === ACTION.TAKE_OUT_MONEY) {
                    current_state = STATE.TAKING_OUT_MONEY_1;
                    break;
                }
            ...
            case STATE.TAKING_OUT_MONEY_1:
                if (current_action === ACTION.EXIT) {
                    current_state = STATE.SELECTING_OPERATION;
                    break;
                }
                if (current_action === ACTION.TYPE_DIGIT) {
                    current_state = STATE.TAKING_OUT_MONEY_2;
                    break;
                }
                break;

            case STATE.TAKING_OUT_MONEY_2:
                if (current_action === ACTION.EXIT) {
                    current_state = STATE.SELECTING_OPERATION;
                    break;
                }
    ...
    function updateInternals() {
        switch (current_state) {
            ...
            case STATE.TAKING_OUT_MONEY_1:
                ...
                displayed_text = 'Introduzca importe y pulse [->]';
                break;
